...
const HOSPITAL_COLUMNS = [
  ...
  },
  {
    ...
    label: 'State',
    render: (hospital: Hospital) => (
      <div className="text-gray-600">{hospital.state || '—'}</div>
    )
  },
  {
    key: 'phone',
  ...
  },
  {
    ...
    label: 'Type',
    render: (hospital: Hospital) => (
      <div className="capitalize text-gray-600">{hospital.type || 'Hospital'}</div>
    )
  }
];
  ...
  return (
    <div className="w-full pt-6 h-full flex flex-col bg-white overflow-hidden">
      ...
      <DataTable<Hospital>
        ...
        emptyMessage={searchTerm ? `No matches for "${searchTerm}"` : "No hospitals found."}
